#!/usr/bin/env python3
"""
Extrinsic Region for Semiconductor Bandgap Analysis
...
def plot_results(
    ...
    plt.title(f"Semiconductor Resistance {bounds[0]}–{bounds[1]}", fontsize=16)
...
def print_menu() -> None:
    ...
    print("\Semiconductor Bandgap Analysis Menu")
    print("=" * 30)
